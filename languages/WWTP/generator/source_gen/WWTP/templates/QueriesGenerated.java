...
public class QueriesGenerated extends QueryProviderBase {
  ...
  public static boolean rule_Condition_3_3(final BaseMappingRuleContext _context) {
    return Objects.equals(SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.metric$vNf_), PROPS.name$MnvL), "Network throughput in") || Objects.equals(SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.metric$vNf_), PROPS.name$MnvL), "Network_throughput_out");
  }
  ...
  public static Object propertyMacro_GetValue_0_30(final PropertyMacroContext _context) {
    return SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.container$LsCU), PROPS.name$MnvL);
  }
  ...
  private final Map<String, SourceNodeQuery> snqMethods = new HashMap<String, SourceNodeQuery>();
  {
    ...
    snqMethods.put("451796079160451693", new SNQ(i++));
    snqMethods.put("451796079160451702", new SNQ(i++));
    snqMethods.put("6313570324824794360", new SNQ(i++));
    snqMethods.put("6313570324824794033", new SNQ(i++));
    snqMethods.put("451796079160455422", new SNQ(i++));
    snqMethods.put("451796079160455431", new SNQ(i++));
    snqMethods.put("6313570324824790853", new SNQ(i++));
    snqMethods.put("6313570324824791172", new SNQ(i++));
    snqMethods.put("4074468789326757115", new SNQ(i++));
  ...
  {
    int i = 0;
    snsqMethods.put("5316509231250037761", new SNsQ(i++));
    ...
    snsqMethods.put("5316509231250048221", new SNsQ(i++));
    ...
    snsqMethods.put("1490801959943006212", new SNsQ(i++));
  ...
  private final Map<String, PropertyValueQuery> pvqMethods = new HashMap<String, PropertyValueQuery>();
  {
    ...
    pvqMethods.put("6883678459169380212", new PVQ(i++, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name"), "container"));
    ...
    pvqMethods.put("5316509231250078492", new PVQ(i++, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name"), "name"));
    pvqMethods.put("5316509231250078500", new PVQ(i++, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name"), "mPath"));
    pvqMethods.put("5316509231250078521", new PVQ(i++, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name"), "sPath"));
  ...
  private final Map<String, IfMacroCondition> imcMethods = new HashMap<String, IfMacroCondition>();
  {
    ...
    imcMethods.put("5316509231250078563", new IfMC(i++));
    imcMethods.put("8510706739518043245", new IfMC(i++));
    imcMethods.put("8510706739518076482", new IfMC(i++));
    imcMethods.put("8510706739518097030", new IfMC(i++));
  ...
  private static final class LINKS {
    ...
    /*package*/ static final SReferenceLink container$LsCU = MetaAdapterFactory.getReferenceLink(0x222ccd66f9d64014L, 0x8569354bddee8138L, 0x12549f92e660b9ceL, 0x12549f92e660b9cfL, "container");
