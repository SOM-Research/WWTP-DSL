  ...
  public static class Name_Property extends BasePropertyConstraintsDescriptor {
    ...
    public boolean validateValue(SNode node, Object propertyValue, CheckingNodeContext checkingNodeContext) {
      ...
      if (!(result) && checkingNodeContext != null) {
        checkingNodeContext.setBreakingNode(new SNodePointer("r:ef5b13d7-d5e8-4ebf-a18f-76c256afe20a(WWTP.constraints)", "2523733536485717345"));
      }
      return result;
    }
      ...
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseScopeProvider() {
          ...
          public SNodeReference getSearchScopeValidatorNode() {
            return new SNodePointer("r:ef5b13d7-d5e8-4ebf-a18f-76c256afe20a(WWTP.constraints)", "3242911558878742434");
          }
          @Override
