...
import Shapes.blocks.Bio_Reactor;
...
/*package*/ class Bio_Reactor_graphical_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Bio_Reactor_graphical_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createDiagramNode_0(final EditorContext editorContext, final SNode node) {
    ...
    ContextVariables.withValue("thisNode", node, new Runnable() {
      public void run() {
        ...
        final IShape shape = new Bio_Reactor();
        ...
        editorCell.value.setCellId("DiagramNode_d83oti_a");
        editorCell.value.setBig(true);
        setCellContext(editorCell.value);
        Style style = new StyleImpl();
        style.set(StyleAttributes.getInstance().<Color>getAttribute("de.itemis.mps.editor.diagram.styles", "__shade-color"), StyleRegistry.getInstance().getSimpleColor(_StyleParameter_QueryFunction_d83oti_a0a()));
  ...
  private Color _StyleParameter_QueryFunction_d83oti_a0a() {
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_d83oti_a0");
