...
/*package*/ class Cloud_Node_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_1() {
    AbstractCellListHandler handler = new containersListHandler_ryqr2o_w0(myNode, getEditorContext());
  ...
  private static class containersListHandler_ryqr2o_w0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public containersListHandler_ryqr2o_w0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(containersListHandler_ryqr2o_w0.this.getNode(), LINKS.containers$eu$n));
      try {
        EditorCell emptyCell = null;
        emptyCell = super.createEmptyCell();
        installElementCellActions(null, emptyCell, true);
