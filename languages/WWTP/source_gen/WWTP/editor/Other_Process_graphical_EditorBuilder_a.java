...
/*package*/ class Other_Process_graphical_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Other_Process_graphical_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createDiagramNode_0(final EditorContext editorContext, final SNode node) {
    ...
    ContextVariables.withValue("thisNode", node, new Runnable() {
      public void run() {
        ...
        editorCell.value.setCellId("DiagramNode_q6e5ak_a");
        editorCell.value.setBig(true);
        setCellContext(editorCell.value);
        Style style = new StyleImpl();
        style.set(StyleAttributes.getInstance().<Color>getAttribute("de.itemis.mps.editor.diagram.styles", "__shade-color"), StyleRegistry.getInstance().getSimpleColor(_StyleParameter_QueryFunction_q6e5ak_a0a()));
  ...
  private Color _StyleParameter_QueryFunction_q6e5ak_a0a() {
    if (SEnumOperations.getMemberName0(SPropertyOperations.getEnum(getNode(), PROPS.fluid$uhvk)) == "Sludge") {
      return Color.orange;
    }
    if (SEnumOperations.getMemberName0(SPropertyOperations.getEnum(getNode(), PROPS.fluid$uhvk)) == "Water") {
      return new Color(170, 189, 222);
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_q6e5ak_a0");
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_q6e5ak_c0a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.HORIZONTAL_ALIGN, CellAlign.CENTER);
    style.set(StyleAttributes.FONT_STYLE, MPSFonts.ITALIC);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_q6e5ak_a2a0");
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ">");
    editorCell.setCellId("Constant_q6e5ak_c2a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
