...
/*package*/ class Sensor_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_qb70eh_i0");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new regionsListHandler_qb70eh_a8a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Horizontal(), false);
    editorCell.setCellId("refNodeList_regions");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class regionsListHandler_qb70eh_a8a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public regionsListHandler_qb70eh_a8a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(regionsListHandler_qb70eh_a8a.this.getNode(), LINKS.regions$svWv));
      try {
