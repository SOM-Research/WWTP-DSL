...
public class Sensor_Events_SubstituteMenu extends SubstituteMenuBase {
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("default substitute menu for Sensor_Events. Generated from the smart reference attribute.", new SNodePointer("r:589c5fd8-b628-4aae-9e87-31a99b5068a7(WWTP.structure)", "5982629958609110369")));
    try {
